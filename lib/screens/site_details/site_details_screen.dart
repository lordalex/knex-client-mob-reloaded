...
///
/// Shows hero image, name, address, rating, action buttons (Request Valet, Call),
/// bio/description, and a favorite toggle.
class SiteDetailsScreen extends ConsumerWidget {
  ...
  void _showDisclaimerDialog(BuildContext context, ValetLocation location) {
    // Capture the parent context for GoRouter navigation after dialog dismisses.
